# 🎨 Gemini Image Prompts (copy-paste ready)
...
Style: cute 3D animated pixar-style, soft rounded shapes, big expressive eyes,
warm pastel cozy lighting, miniature cottage setting, ultra adorable, high detail,
clean render, family-friendly.
```

## 4) THEIR HOME — establishing shot (reuse in every vlog intro)

```
A cozy miniature cottage house interior, warm wooden walls, tiny pastel kitchen
with miniature stove and tiny pans, soft cushions, fairy lights, wooden table,
big round window with soft morning sunlight streaming in, no characters, wide shot.
Style: cute 3D animated pixar-style, warm pastel cozy lighting, miniature cottage
setting, ultra adorable, high detail, clean render, family-friendly.
```
